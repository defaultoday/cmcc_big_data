    ...
    def run(self,que=None):
        ...
        while True:
            ...
            try:
                ...
                date_input = self.browser.find_element_by_xpath('/html/body/div[1]/div/div/div/div[1]/div/div[3]/div/div[1]/ul/div/div[2]/li/div/div[1]/input')
                date_input.clear()
                ...
                time.sleep(5)
                #点击质检
                self.browser.find_element_by_xpath('/html/body/div[1]/div/div/div/div[2]/div/div/div[1]/div[2]/div[7]/button/span[contains(text(),"质检")]').click()
...
if(__name__ == "__main__"):
    ...
    for i in range(0,thread_count):
        send_thread = threading.Thread(target=unlockcheck_stack,args=(path_pre+str(i)+".txt","./data/Unlockcheck_Thread"+str(i)+".txt"))
